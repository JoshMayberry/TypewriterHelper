...
namespace jmayberry.TypewriterHelper {
    [Serializable]
    public class PortraitChatBubbleInfo<EmotionType> : BaseChatBubbleInfo where EmotionType : Enum {
    ...
    public class PortraitDialogManager<SpeakerType, EmotionType> : BaseDialogManager<SpeakerType> where SpeakerType : Enum where EmotionType : Enum {
